...
cmake -DTARGET_ARCHITECTURE="x86-64" -DCMAKE_SYSTEM_NAME=Linux -DCMAKE_CXX_COMPILER=clang-12 -DCMAKE_CXX_COMPILER=clang++-12 -DCMAKE_CXX_STANDARD=17 -DCMAKE_BUILD_TYPE=$BUILD_TYPE .. -G "Ninja"
ninja -j6
cd $PWD